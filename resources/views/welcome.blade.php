                                        ...
                                        <div class="row d_flex">
                                            <div class="col-md-5">
                                                <div class="zon_text">
                                                    ...
                                                    <button class="btn btn-primary  read_more bounceInLeft"
                                                        data-animation="animated bounceInLeft">Read More</button>
                                                    <button class="btn btn-primary  read_more bounceInLeft"
                                                        data-animation="animated bounceInLeft">Get A Quote</button>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="coff_img">
                                                    <figure><img src="assets/images/coff_img.png" alt="#" />
                                                    </figure>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                <form id="request" class="main_form">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <input class="contactus" placeholder="Your name" type="type"
                                                name=" Name">
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="testimonial">
                        ...
                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="testimonial_box text_align_left">
                                                                <p>uffered alteration in some form, by injected humour,
                                                                    or randomised words which don't look even slightly
                                                                    believable. If you are going touffered alteration in
                                                                    some form, by injected humour, or randomised words
                                                                    which don't look even slightly believable. If you
                                                                    are going touffered alteration in some form, by
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="testimonial_pro">
                                                                <figure><img src="assets/images/test_pro.jpg"
                                                                        alt="#" /></figure>
                                                                <h3>Mark Jonson <br><span
                                                                        class="cust">Customre</span></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="coff">
                                    <figure><img src="assets/images/coff.png" alt="#" /></figure>
                                </div>
                            </div>
                        </div>
                    </div>
